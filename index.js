...
// The nestedFunction can access the variable internal because it resides within the scope of myFunction, therefore it can use closure to reach outside of itself and  access the variable "internal".
